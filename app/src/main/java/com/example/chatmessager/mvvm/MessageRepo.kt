            ...
            .addSnapshotListener{
                ...
                if(!snapshot!!.isEmpty){
                    snapshot.documents.forEach {
                        ...
                        if(messageModel!!.sender.equals(Utils.getUidLoggedIn()) && messageModel.receiver.equals(friendid) || messageModel.sender.equals(friendid) && messageModel.receiver.equals(Utils.getUidLoggedIn())){
                            messageModel.let {
                                messagesList.add(it!!)
                            }
                        }
