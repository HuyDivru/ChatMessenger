package com.example.chatmessager.adpater
...
class MessageAdapter: RecyclerView.Adapter<MessageHolder>() {
    ...
    override fun getItemViewType(position: Int)=if(listOfMessage[position].sender==Utils.getUidLoggedIn()) RIGHT else LEFT
